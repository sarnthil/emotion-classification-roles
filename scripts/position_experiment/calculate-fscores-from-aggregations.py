...
# for file in Path("workdata/position-experiment/predictions").glob("*.aggregated"):
for dataset_path in Path("workdata/position-experiment/predictions").glob("*"):
    ...
    with Path("workdata/position-experiment/results.json").open("w") as f:
        json.dump(results, f)
